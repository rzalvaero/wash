        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url('kendaraan') ?>">Jenis Paket</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card-body">
              ...
              <?php foreach ($jenis as $row) { ?>
                <tr>
                  ...
                  <td><?php echo strtoupper($row['nama_paket']) ?></td>
                  <td><?php echo strtoupper($row['nama_kendaraan']) ?></td>
                  <td>
                    <?php if ($row['jenis_kendaraan'] == '1') { ?>
                      <b class="btn-danger">NON MEMBER</b>
                    <?php }else{ ?> 
