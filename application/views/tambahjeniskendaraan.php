        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url('jeniskendaraan') ?>">Jenis Palet</a></li>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">Form Tambah Jenis Paket</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?php echo base_url('jeniskendaraan/tambahkendaraan') ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="" placeholder="Nama Paket" required="" name="nama_paket">
                   <?php echo form_error('Nama_paket'),'<small class="text-danger pl-3">','</small>'; ?>
                  </div>
                  <div class="form-group">
