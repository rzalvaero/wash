          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">View Jenis</li>
              </ol>
            </div>
          </div>
          </div><!-- /.container-fluid -->
              ...
              <div class="col-md-12">
                ...
                <div class="card card-default">
                  <div class="card-header">
                    <h3 class="card-title">KODE Jenis Kendaraan[<?php echo $kendaraan['kd_kendaraan'] ?></h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form action="<?php echo base_url('jeniskendaraan/updatekendaraan') ?>" method="post">
                    <div class="card-body">
                      <div class="row">
                        <div class="col">
                          <div class="form-group">
                            <label for="nama">Jenis Kendaraan</label>
                            <input type="text" class="form-control" id="" placeholder="Jenis Kendaraan" required="" name="nama" value="<?php echo $kendaraan['nama_kendaraan'] ?>">
                          </div>
                          <!--<div class="form-group">
                            <label for="nama">TIPE <?php if ($kendaraan['jenis_kendaraan'] == '1') { ?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="input-group-prepend">
                                ...
                                </div><input type="number" class="form-control" id="" placeholder="Harga Kendaraan" value="<?php echo $kendaraan['harga_kendaraan'] ?>" name="harga">
                              </div>
                            </div>
                          </div>
                        </div>
