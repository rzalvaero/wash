          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="<?php echo base_url('Masuk') ?>">Washin</a></li>
              </ol>
            </div>
          </div>
          </div><!-- /.container-fluid -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="input-group-prepend">
                            ...
                            <input type="text" class="form-controla" id="" placeholder="Kode Karcis" name="karcis" size="17px">
                          </div>
                        </div>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php foreach ($keluar as $row) { ?>
                      <tr>
                        ...
                        <td>Rp <?php echo $row['tarif_keluar'] ?></td>
                        <td><?php echo $row['create_keluar'] ?></td>
                        <td><center><a target="_blank" href="<?php echo base_url('keluar/detail/'.$row['kd_keluar']) ?>"><i class="fa fa-barcode"></i></a></center></td>
                      </tr>
                    <?php } ?>
                    </tfoot>
                    </table>
