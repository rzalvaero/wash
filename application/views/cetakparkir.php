...
use Mike42\Escpos\PrintConnectors\DummyPrintConnector; //DummyPrintConnector;

$connector = new DummyPrintConnector("POS58"); //DummyPrintConnector("POS58");
...
$printer -> text("KEHILANGAN TIKET DI KENAKAN DENDA Rp.10.000,-");
$printer -> feed();
$printer -> text("----------------------------------------\n");
$printer->cut();
$printer->close();
