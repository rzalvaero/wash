...
class Home extends CI_Controller {
	...
	public function index(){
		...
		$data['masuk'] = $this->db->query("SELECT count(kd_masuk) FROM tbl_masuk WHERE tgl_masuk LIKE '".date('Y-m-d')."%' AND status_masuk LIKE '1' OR status_masuk LIKE '2'")->row_array();
