...
class Keluar extends CI_Controller {
	...
	public function detail($id=''){
	    $sqlcek = $this->db->query("SELECT * FROM tbl_keluar RIGHT JOIN tbl_masuk ON tbl_masuk.kd_masuk = tbl_keluar.kd_masuk WHERE kd_keluar LIKE '".$id."'")->row_array();
		//$sqlcek = $this->db->query("SELECT * FROM tbl_masuk RIGHT JOIN tbl_kendaraan ON tbl_masuk.kd_kendaraan = tbl_kendaraan.kd_kendaraan WHERE kd_masuk LIKE '".$id."'")->row_array();
		$data['cetak'] = $sqlcek;
		$this->load->view('cetak/printkeluar', $data);
	}
